...
from Network.Network import CIFAR10Model, SIMPLE_NET, MY_RESNET, MY_ResneXt
...
def TrainOperation(ImgPH, LabelPH, DirNamesTrain, TrainLabels, NumTrainSamples, ImageSize,
    ...
    prLogits, prSoftMax = MY_ResneXt(ImgPH, ImageSize, MiniBatchSize)
    ...
    with tf.name_scope('Accuracy'):
        ...
        LabelDecoded = tf.argmax(LabelPH, axis=1)       #y_true_cls
...
def main():
    ...
    Parser.add_argument('--NumEpochs', type=int, default=100, help='Number of Epochs to Train for, Default:50')
